...
module.exports = {
    ...
    createPostRegister: () => {
        return new Promise((resolve, reject) => {
            db.query("create table if not exists postRegister (postId int auto_increment, isPrincipal boolean, creation_date date, parentId int, ancestorId int, likes int default 0, usersVoted json, primary key (postId))")
        }, (err) => {
            if (err) {
                reject(err)
            }
    ...
    addtoPostRegister: ({ parentId, date, isPrincipal, ancestorId }) => {
        const usersVoted = []
        return new Promise((resolve, reject) => {
    ...
    addNewPost: (ancestorId, postItem) => {
        return new Promise((resolve, reject) => {
    ...
    getStructureByAncestor: (ancestorId) => {
        return new Promise((resolve, reject) => {
    ...
    getPostRegisterByPostId: (postId) => {
        return new Promise((resolve, reject) => {
    ...
    updatePostLikes: (likes, usersVoted, postId) => {
        return new Promise((resolve, reject) => {
